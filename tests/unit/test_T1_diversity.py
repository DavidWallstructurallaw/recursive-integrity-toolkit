"""Phase 1 placeholder for T1.

Planned scope:
    Future diversity tests are deferred to Phase 3.
...
def test_T1_diversity_owner_and_placeholder(owner_checker, placeholder_checker):
    owner_checker("metrics/diversity.py", "T1")
    placeholder_checker("metrics/diversity.py")
